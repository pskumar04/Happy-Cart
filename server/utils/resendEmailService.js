...
exports.sendOrderConfirmation = async (customerEmail, order, customerName) => {
  try {
    const { data, error } = await resend.emails.send({
      from: 'Happy Cart <onboarding@resend.dev>', // CHANGED THIS LINE
      to: [customerEmail],
...
exports.sendSupplierNotification = async (supplierEmail, order, supplierName) => {
  try {
          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <div style="text-align: center; margin-top: 30px;">
                <a href="${process.env.CLIENT_URL}/supplier-dashboard" style="background: #f5576c; color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; display: inline-block;">
    ...
    console.error('❌ Error sending supplier notification:', error.message);
  }
};
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <div style="text-align: center; margin-top: 30px;">
                <a href="${process.env.CLIENT_URL}/supplier-dashboard" style="background: #f39c12; color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; display: inline-block;">
                  Go to Supplier Dashboard
                </a>
              </div>
            </div>
...
exports.sendReturnStatusUpdate = async (customerEmail, order, customerName, item, newStatus, adminNotes = '') => {
  try {
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <div style="text-align: center; margin-top: 30px;">
                <a href="${process.env.CLIENT_URL}/my-orders" style="background: #667eea; color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; display: inline-block;">
                  View My Orders
                </a>
              </div>
            </div>
    ...
    if (error) {
      console.error('❌ Error sending return status update:', error);
      return;
    }
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <div style="text-align: center; margin-top: 30px;">
                <a href="${process.env.CLIENT_URL}/my-orders" style="background: #667eea; color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; display: inline-block; font-weight: bold;">
                  View My Orders
                </a>
              </div>
            </div>
